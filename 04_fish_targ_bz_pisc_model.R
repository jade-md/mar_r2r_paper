...
reef <- "fish"
model <- "2"
response_var <- "pisc_bz"  	#response variable attribute field name
output_name <- "pisc_bz"	#generic name of response variable for use in output file names
